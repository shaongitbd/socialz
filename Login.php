...
'
 ...
 <div class=" h-screen flex justify-center items-center  bg-gray-50 " id="particles-js" >

  <div class="absolute  border border-gray-300 bg-white   gap-2 px-8 py-6 rounded-md w-1/5 shadow-md ">
